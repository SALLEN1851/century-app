...
import GravaFlowPlanner from '@/components/GravaFlowPlanner'

export default function TerraFlowPage() {
  ...
  // fetch minimal WHOOP data the planner uses
  useEffect(() => {
  ...
  if (status === 'unauthenticated') return <div className="grid min-h-[60vh] place-items-center text-sm">Please sign in to use TerraFlow.</div>

  return (
    <main className="lg:pl-72">
      <div className="xl:pr-96">
        <div className="px-4 py-10 sm:px-6 lg:px-8 lg:py-6 space-y-6">
          <h1 className="text-xl font-bold">GravaFlow Planner</h1>
          ...
          {loading && !whoopData ? (
            ...
            <GravaFlowPlanner whoopData={whoopData} goal={goal} className="mb-6" />
          )}
